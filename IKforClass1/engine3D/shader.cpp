...
void Shader::Update(glm::mat4 MVP, glm::mat4 Normal, int const shpIndx, std::vector<glm::mat4> T, glm::vec4* ambient, glm::vec3* eye)
{
	...
	std::vector<glm::vec3> directions = { glm::vec3(0.0f, 0.0f, 1.0f),glm::vec3(01.0f, 1.0f, 01.0f) };
